...
class PetFriends:
    ...
    '''
        Реализация API-методов (первая часть практического задания 24.7.2):
         - POST /api/create_pet_simple          /добавление информации о новом питомце без фотографии
         - POST /api/pets/set_photo/{pet_id}    /добавление фотографии питомца
    '''
